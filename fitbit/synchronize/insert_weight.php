...
for ($x = 0; $x < $arrayLenght; $x++) {
    ...
    //SQL Statement to
    $select = "SELECT * FROM value WHERE user_id='$userId' AND measurement_id='$weightId' AND company_id='$companyId' AND date= '$date' ";
...
//SQL Statement to insert data into value table
        ...
        VALUES ('$userId', '$weightId', '$companyId', '$weight','$date')";
        ...
        $update = "UPDATE value SET value = '$weight'
                                     WHERE user_id='$userId' AND measurement_id='$weightId' AND company_id='$companyId' AND date = '$date'";
