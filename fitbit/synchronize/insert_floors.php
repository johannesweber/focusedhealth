...
for ($x = 0; $x < $arrayLenght; $x++) {
    ...
    //SQL Statement to
    $select = "SELECT * FROM value WHERE user_id='$userId' AND measurement_id='$floorsId' AND company_id='$companyId' AND date= '$date' ";
...
//SQL Statement to insert data into value table
        ...
        VALUES ('$userId', '$floorsId', '$companyId', '$floors','$date')";
        ...
        $update_weight = "UPDATE value set value = '$floors'
                                     WHERE user_id='$userId' AND measurement_id='$floorsId' AND company_id='$companyId' AND date = '$date'";
