...
for ($x = 0; $x < $arrayLength; $x++) {
    ...
    //SQL Statement to
    $select = "SELECT * FROM value WHERE user_id='42' AND measurement_id='$minutesAsleepId' AND company_id='$company_id' AND date= '$date' ";
...
//SQL Statement to insert data into value table
        ...
        VALUES ('42', '$minutesAsleepId', '$company_id', '$minutesAsleep','$date')";
        ...
        $update = "UPDATE value SET value = '$minutesAsleep'
                                     WHERE user_id='42' AND measurement_id='$minutesAsleepId' AND company_id='$company_id' AND date = '$date'";
